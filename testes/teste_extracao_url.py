...
url_extraido = dado_saude.extrair_url()

assert len(url_extraido) > 0, "A extração falhou: o conteúdo retornou vazio!"

print(f"Teste concluído: Dados extraídos com sucesso ({len(url_extraido)} caracteres).")